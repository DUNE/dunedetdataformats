...
get_trigger_candidate_type_names()
{
  return {
    ...
    { TriggerCandidateData::Type::kCTBBeamChkvH, "kCTBBeamChkvH" },
    { TriggerCandidateData::Type::kCTBBeamChkvL, "kCTBBeamChkvL" },
    { TriggerCandidateData::Type::kCTBBeamChkvHx, "kCTBBeamChkvHx" },
    { TriggerCandidateData::Type::kCTBBeamChkvLx, "kCTBBeamChkvLx" },
